<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Index2.aspx.cs" Inherits="WebInfo.Index" %>
...
<script type="text/javascript" >
        ...
        function dispdata() {
            var doms = $("table[data-type]");
            var id = "";
            for (var i = 0; i < doms.length; i++) {
                id = doms[i].getAttribute("data-type");
                if (id != "") {
                    $.ajax({
                        ids: id,
                        type: "GET",
                        dataType: "json",
                        url: "/GetCardetial.ashx?page=1&order=1&carsort="+id,
                        data: {},
                        success: function (data) {
                            for (var i = 0; i < data.length && i < 10; i++) {
                                ...
                                $("table[data-type='" + this.ids + "']").append(txt);
                            }
...
<div class="brand_box">
    <ul class="brand_tab clearfix common_bg">
        ...
        <li><a href="/Search.aspx?mod=index&ac=index&carsort=4&s_type=1">轿车</a></li>
        <li><a href="/Search.aspx?mod=index&ac=index&carsort=28&s_type=1">跑车</a></li>
        <li><a href="/Search.aspx?mod=index&ac=index&carsort=31&s_type=1">商务车</a></li>
        <li><a href="/Search.aspx?mod=index&ac=index&carsort=29&s_type=1">越野车</a></li>
        <li><a href="/Search.aspx?mod=index&ac=index&carsort=33&s_type=1">蓝牌面包车</a></li>
        <li><a href="/Search.aspx?mod=index&ac=index&carsort=34&s_type=1">黄牌客车</a></li>
        <li><a href="/Search.aspx?mod=index&ac=index&carsort=32&s_type=1">皮卡</a></li>
        <li><a href="/Search.aspx?mod=index&ac=index&carsort=37&s_type=1">货车</a></li>
    </ul>
...
<!--品牌关键词-->	
		<div class="showsreachbox">
			<form name="form2" id="form2" method="get" action="/Search.aspx">
...
<span>
				...
				<input type="image" class="hide" src="/static/img/show/search.gif" onFocus="if(form2.p_no.value==form2.p_no.defaultValue){form2.p_no.value='';};if(form2.keywords.value==form2.keywords.defaultValue){form2.keywords.value='';}" />
    ...
    { %><div class="car_order mt5">
            <%}
                i++;%>
			<ul class="clearfix">
				<li style="width:930px;" class="fb f14 blue01"><a href="/Search.aspx?mod=index&ac=index&carsort=4&s_type=1" target="_blank" class="fr f12 fn">更多>></a><%=k.Key.DisplayName %></li>
			</ul>
		</div>     
		<div class="carbox2"> 
			<table  border="0" cellspacing="0" cellpadding="0" class="wordlist" align="center" >
                ...
                <%var pic = "";
					...
					<td align="center"><%=v.SellerNumber %></td>
					<td align="left"><a href="/item.aspx?id=<%=v.Id %>" target="_blank"><%=v.ProTitle %></a><%=pic %></td>
					<td align="center"><a href="/item.aspx?id=<%=v.Id %>"  target="_blank"><%=k.Key.DisplayName %></a></td>
					<td align="center"><a href="/item.aspx?id=<%=v.Id %>"  target="_blank"><%=v.ShangPaiYear %>年<%=v.ShangPaiMonth %>月</a></td>
					<td align="center"><a href="/item.aspx?id=<%=v.Id %>"  target="_blank"><%=v.CarColor %></a></td>
					<td align="center"><a href="/item.aspx?id=<%=v.Id %>"  target="_blank"><span class="red"><%=v.baojia.ToString("#0.00") %><span class=black>万</span></span></a></td>
					<td align="center"><a href="/item.aspx?id=<%=v.Id %>"  target="_blank"><%=v.BianShuQi %></a></td>
					<td align="center"><a href="/item.aspx?id=<%=v.Id %>"  target="_blank"><%=v.CreateTime.ToShortDateString() %></a></td>
					<td align="center"><a href="/item.aspx?id=<%=v.Id %>"  target="_blank"><%=v.ProNum  %></a></td>
				</tr>                              
                <%} %>
			</table>
		</div>
